...
const Dashboard = ({ userRole }) => {
  ...
  const [posts, setPosts] = useState([
    { id: 1, title: "Initial System Check", platforms: ["LinkedIn", "Twitter/X"] }
  ]);
  ...
  const handleEditPost = (id, currentTitle) => {
    const newTitle = prompt("Edit your post content:", currentTitle);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 20px", fontFamily: "system-ui, sans-serif", backgroundColor: "#f9fafb", minHeight: "85vh" }}>
      <div style={{ background: "#ffffff", padding: "32px", borderRadius: "16px", boxShadow: "0 10px 25px rgba(0, 0, 0, 0.05)", border: "1px solid #e5e7eb", width: "100%", maxWidth: "600px" }}>
        ...
        <h2 style={{ color: "#aa3bff", marginTop: 0, marginBottom: "8px", textAlign: "center" }}>Multi-Platform Composer</h2>
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "24px" }}>
          <span style={{ background: "#f3f4f6", padding: "6px 16px", borderRadius: "999px", fontSize: "12px", fontWeight: "700", color: "#374151", border: "1px solid #d1d5db", textTransform: "uppercase", letterSpacing: "1px" }}>
            ...
            <li key={post.id} style={{ display: "flex", flexDirection: "column", gap: "12px", padding: "16px", background: "#f3f4f6", borderRadius: "12px", border: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  {userRole === "editor" && (
                    <button onClick={() => handleEditPost(post.id, post.title)} style={{ padding: "6px 12px", fontSize: "13px", fontWeight: "bold", background: "#3b82f6", color: "#ffffff", border: "none", borderRadius: "6px", cursor: "pointer" }}>
                      Edit
                    </button>
                  )}
